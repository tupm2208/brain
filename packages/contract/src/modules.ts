...
export const MODULES: { readonly [K in ModuleId]: ModuleDef } = {
  ...
  "don-khach": {
    ...
    tools: ["order.lookup", "order.draft", "policy.get", "customer.recognize", "shop.bankAccount", "order.formLink"],
  ...
  "hop-thu": {
    ...
    tools: ["conversation.recent", "training.knowledge", "shop.profile"], emits: [], listens: ["bot.handoff"], dependsOn: ["don-khach"]
  },
  "chatbot-cskh": {
