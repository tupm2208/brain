...
/** Chi dam noi "ben em khong kinh doanh hang X" khi muc luc du lon. */
 | {
    kind: "brand_not_carried_needs_catalog";
    minItems: number;
}
...
export declare const REQUIRED_TEMPLATES: readonly ["greeting", "ask_item", "ask_slot", "handoff", "offline", "brand_not_carried", "out_of_stock", "in_stock"];
